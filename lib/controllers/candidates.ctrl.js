    ...
    console.log(req.files[0])
      // for (var i = 0; i < req.files.length; i++) {
        ...
        .then(data => {
          ...
          var prompt = "Summarize the text below into a JSON with exactly the following structure {first_name, last_name, full_name, Email, PhoneNo, Address, DOB in format \"DD/MM/YYYY\", City, State, Pincode, Skill Set, Additional Info, Gender, [CUSTOM_FIELDS]}. strictly keep Additional Info and Address should be merge in one single paragraph, Skill Set strictly in comma sperated string [CUSTOM_DESCRIPTION]:"+data;
