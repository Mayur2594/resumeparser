 ...
 * @param cbGetResume
 */
 ParseBoy.prototype.extractTextFromFile = function(PreparedFile, cbGetResume) {
  logger.trace("extractTextFromFile: I'm working with \"" + PreparedFile.name + '" now');
  cbGetResume(PreparedFile.raw)
};
